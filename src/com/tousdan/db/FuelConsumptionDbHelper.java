...
public class FuelConsumptionDbHelper extends SQLiteOpenHelper {
	...
	private static final String SQL_CREATE_GAS_ENTRIES =
	    "CREATE TABLE " + FuelConsumptionContract.GasEntry.TABLE_NAME + " (" +
	    		...
	    		FuelConsumptionContract.GasEntry.COLUMN_NAME_DATE_ADDED + TIMESTAMP_TYPE + COMMA_SEP +
	    		FuelConsumptionContract.GasEntry.COLUMN_NAME_DATE_LAST_MODIFIED + TIMESTAMP_TYPE + COMMA_SEP +
	...
	private static final String SQL_CREATE_VEHICULE_ENTRIES =
	    "CREATE TABLE " + FuelConsumptionContract.VehicleEntry.TABLE_NAME + " (" +
	    		...
	    		FuelConsumptionContract.VehicleEntry.COLUMN_NAME_DATE_ADDED + TIMESTAMP_TYPE + COMMA_SEP +
	    		FuelConsumptionContract.VehicleEntry.COLUMN_NAME_DATE_LAST_MODIFIED + TIMESTAMP_TYPE + COMMA_SEP +
